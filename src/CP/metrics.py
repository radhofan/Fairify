...
if __name__ == "__main__":
    ...
    # Model paths
    ORIGINAL_MODEL_NAME = "CP-1"
    FAIRER_MODEL_NAME = "CP-1-Retrained"
    ORIGINAL_MODEL_PATH = f'Fairify/models/compass/{ORIGINAL_MODEL_NAME}.h5'
    FAIRER_MODEL_PATH = f'Fairify/models/compass/{FAIRER_MODEL_NAME}.h5'
    ...
    df, X_train, y_train, X_test, y_test, encoders = load_compass()
