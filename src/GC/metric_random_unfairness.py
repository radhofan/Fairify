...
class FairnessEvaluator:
    ...
    def __init__(self, model, constraint, protected_attribs=None, num_attribs=20):
        self.model = model
        self.constraint = constraint
        self.protected_attribs = protected_attribs if protected_attribs else [11]  
...
if __name__ == "__main__":
    ...
    constraint = np.array([
        ...
        [0, 2],       # savings
        [0, 2],       # employment
        [1, 4],       # investment_as_income_percentage
        [0, 2],       # other_debtors
        [1, 4],       # residence_since
        [0, 2],       # property
        [0, 1],       # age
        [0, 2],       # installment_plans
        [0, 2],       # housing
        [1, 4],       # number_of_credits
        [0, 3],       # skill_level
        [1, 2],       # people_liable_for
        [0, 1],       # telephone
        [0, 1],       # foreign_worker
        [0, 1],       # sex
    ])
